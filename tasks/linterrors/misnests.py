...
regexes = {
    ...
    r"<(?!(?:nowiki|syntaxhighlight))([^ >]*)( [^>]*)?>( *)<(?!(?:nowiki|syntaxhighlight|\1))([^ >]*)( [^>]*)?>((?:(?!(?:<\/\4>|<\1(?:[^>]*)?>)).)*)<\/\1>((?:(?!<\/\1>).)+)<\/\4>": r"<\1\2>\3<\4\5>\6</\4\5></\1><\4\5>\7</\4>",
    r"<(?!(?:nowiki|syntaxhighlight))([^ >]*)( [^>]*)?>((?:(?!<\/\1>).)+)<(?!(?:nowiki|syntaxhighlight|\1))([^ >]*)( [^>]*)?>((?:(?!(?:<\/\4>|<\1(?:[^>]*)?>)).)*)<\/\1>( *)<\/\4>": r"<\1\2>\3<\4\5>\6</\4\5></\1>",
