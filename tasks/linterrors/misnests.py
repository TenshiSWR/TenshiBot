...
regexes = {
    ...
    r"<(?!(?:nowiki|syntaxhighlight))([^ >]*)( [^>\/]*)?>( *)<(?!(?:nowiki|syntaxhighlight))([^ >]*)( [^>\/]*)?>( *)<(?!(?:nowiki|syntaxhighlight))([^ >]*)( [^>\/]*)?>((?:(?!(?:<\/\4>|<\1(?:[^>]*)?>|<(?!(?:nowiki|syntaxhighlight))([^ >]*)(?: [^>\/]*)?>[^<]*(?!<\/\10>))).)*)<\/\7>((?:(?!<(?!(?:nowiki|syntaxhighlight))([^ >]*)(?: [^>\/]*)?>[^<]*(?!<\/\12>)).)+)<\/\1>( *)<\/\4>": r"<\4\5>\3<\1\2>\6<\7\8>\9</\7>\11</\1>\13</\4>",
    # \6
